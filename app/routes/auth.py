"""Authentication routes used by the React client and inquiry flow."""
...
def login():
    """Authenticate a user and issue a JWT for protected inquiry routes."""
    data = request.get_json(silent=True) or {}
    email = data.get("email")
    password = data.get("password")
...
@jwt_required()
def logout():
    """Acknowledge logout; the client removes its JWT locally."""
